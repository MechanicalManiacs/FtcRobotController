...
public class Vuforia extends SubSystem {
    ...
    public Drive drive = new Drive(robot);
    ...
    public void turnToVumark(String vumark, double power) {
        ...
        for (VuforiaTrackable trackable : allTrackables) {
            if (((VuforiaTrackableDefaultListener)trackable.getListener()).isVisible()) {
                ...
                if (trackable.getName().equals(vumark)) {
                    robot.telemetry.addLine(vumark + "found");
                }
        ...
        if (targetVisible) {
            ...
            /**
             * Checks the heading of the robot.
             * Turns until the robot is inline with the vumark.
             */
            while (heading != 0) {
                if (heading < 0) {
                    drive.turn(-power);
